...
pub use solana_define_syscall::definitions::{
    ...
    sol_get_clock_sysvar,sol_get_greet_sysvar , sol_get_epoch_rewards_sysvar, sol_get_epoch_schedule_sysvar,
    sol_get_epoch_stake, sol_get_fees_sysvar, sol_get_last_restart_slot, sol_get_rent_sysvar,
    sol_get_sysvar, sol_keccak256, sol_remaining_compute_units, bulk_sysvar_fetch
};
